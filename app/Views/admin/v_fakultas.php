                        ...
                        foreach ($fakultas as $key => $value) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#edit<?= $value['id_fakultas'] ?>"><i class="fa fa-edit"></i> </button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete<?= $value['id_fakultas'] ?>"><i class="fa fa-trash"></i></button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label> Fakultas</label>
                        <input name="fakultas" class="form-control" placeholder="fakultas" value="<?php echo $value['fakultas'] ?>" required>
                    </div>
    ...
    <div class="modal fade" id="delete<?= $value['id_fakultas'] ?>">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <p> apakah anda ingin menghapus data ini <b><?= $value['fakultas'] ?></b> </p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left btn-flat" data-dismiss="modal">Close</button>

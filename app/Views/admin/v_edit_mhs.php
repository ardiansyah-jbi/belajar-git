    ...
    <div class="col-sm-6">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart('mhs/update/' . $mhs['id_mhs']);
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $mhs['nama_mhs'] ?>" name="nama_mhs" class="form-control" placeholder="nama mahasiswa">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?= $mhs['password'] ?>" name="password" class="form-control" placeholder="password">
                </div>

                <div class="col-md-6">
                    <div class="form-group">
                        <img src="<?php echo base_url('fotomhs/' . $mhs['foto_mhs']) ?>" id="gambar_load" width="80">
                    </div>
                </div>

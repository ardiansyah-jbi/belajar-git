        ...
        <div class="box box-success box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('ruangan') ?>" class="btn btn-box-tool"><i class="fa fa-close"></i>Tutup</a>
                </div>
                <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Ruangan</label>
                    <input type="text" value="<?= $ruangan['ruangan'] ?>" name="ruangan" class="form-control" placeholder="ruangan" required>
                </div>
